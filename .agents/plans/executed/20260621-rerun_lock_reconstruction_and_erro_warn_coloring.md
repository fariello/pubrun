...
#### [MODIFY] [diagnostics.py](file://~/VC/pubrun/src/pubrun/report/diagnostics.py)
...
#### [MODIFY] [diff.py](file://~/VC/pubrun/src/pubrun/analysis/diff.py)
...
#### [MODIFY] [default.toml](file://~/VC/pubrun/src/pubrun/resources/default.toml)
