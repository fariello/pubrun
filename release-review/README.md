...
- **Instructions**: Follow [01-current-state.md](file://~/VC/pubrun/release-review/01-current-state.md).
...
- **Instructions**: Follow [02-quality-security-edge-cases.md](file://~/VC/pubrun/release-review/02-quality-security-edge-cases.md).
...
- **Instructions**: Follow [03-tests-regression.md](file://~/VC/pubrun/release-review/03-tests-regression.md).
...
- **Instructions**: Follow [04-docs-specs-examples.md](file://~/VC/pubrun/release-review/04-docs-specs-examples.md).
...
- **Instructions**: Follow [05-feature-usability-maintainability.md](file://~/VC/pubrun/release-review/05-feature-usability-maintainability.md).
...
- **Instructions**: Follow [06-compatibility-packaging-release.md](file://~/VC/pubrun/release-review/06-compatibility-packaging-release.md).
...
- **Instructions**: Follow [07-implementation.md](file://~/VC/pubrun/release-review/07-implementation.md).
- **Execution**: 
...
- **Instructions**: Follow [08-final-ship-review.md](file://~/VC/pubrun/release-review/08-final-ship-review.md).
