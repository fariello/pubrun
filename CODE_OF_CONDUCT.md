...
**gfariello@uri.edu**. All complaints will be reviewed and investigated
promptly and fairly.
...
offline interaction with the community, including unsolicited contact with
...
Feedback about cooperative and constructive collaboration can also be shared with maintainers to preserve the lightweight, low-friction, and zero-dependency core of `pubrun` development.
