...
#### [MODIFY] [tests/test_cli.py](file:///home/gfariello/VC/pubrun/tests/test_cli.py)
Update the checked subcommands list to replace `"tui"` with `"ui"`, `"tui"`, `"gui"`.

### B. TUI Command Tests

#### [MODIFY] [tests/test_tui.py](file:///home/gfariello/VC/pubrun/tests/test_tui.py)
...
```bash
/home/gfariello/venv/p3.14/bin/python -m pubrun --help
/home/gfariello/venv/p3.14/bin/python -m pubrun ui --help
/home/gfariello/venv/p3.14/bin/python -m pubrun tui --help
/home/gfariello/venv/p3.14/bin/python -m pubrun gui --help
```
